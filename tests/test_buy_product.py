...
# Тест, который осуществляет добавление продукта в корзину (с авторизацией)
...
# и заканчичая страницей чекаута. При этом происходит сравнение суммы на странице корзины и странице чекаута.
